    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex-1 flex items-center justify-center px-4">
        <div className="text-center max-w-2xl mx-auto">
          <h1 className="text-4xl font-bold mb-6 text-gray-900">Добро пожаловать на МойСайт!</h1>
          <p className="text-xl text-gray-600 mb-8">Начните использовать наш сервис уже сегодня — создайте бесплатный аккаунт.</p>
